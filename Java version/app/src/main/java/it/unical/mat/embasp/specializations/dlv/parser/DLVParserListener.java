...
public interface DLVParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DLVParser#model}.
	 * @param ctx the parse tree
	 */
	void enterModel(DLVParser.ModelContext ctx);
	/**
	 * Exit a parse tree produced by {@link DLVParser#model}.
	 * @param ctx the parse tree
	 */
	void exitModel(DLVParser.ModelContext ctx);
	/**

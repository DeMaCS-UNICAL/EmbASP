...
class SPDDesktopService(DesktopService):
    """Is an extension of DesktopService for SPDD's solver."""
    ...
    def __get_from_file(self, files_paths, separator):
        """Read file from list of path given and return their content, separate
        by separator string given."""
        to_return = ""
    ...
    def start_sync(self, programs, options):
        """Return SPDPlan object represent output generated from SPD solver
        server."""
        if not programs:
